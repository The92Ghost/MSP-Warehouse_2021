...
namespace MSP_Warehouse_2021 {
    ...
    public partial class Database1DataSet3 : global::System.Data.DataSet {
        ...
        public partial class ItemsDataTable : global::System.Data.TypedTableBase<ItemsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ItemsRow AddItemsRow(int IDItem, string ItemName, string ItemDescription) {
...
namespace MSP_Warehouse_2021.Database1DataSet3TableAdapters {
    ...
    public partial class ItemsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Items] WHERE (([IDItem] = @Original_IDItem) AND ([ItemName] = " +
                "@Original_ItemName) AND ([ItemDescription] = @Original_ItemDescription))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Items] ([IDItem], [ItemName], [ItemDescription]) VALUES (@IDIt" +
                "em, @ItemName, @ItemDescription);\r\nSELECT IDItem, ItemName, ItemDescription FROM" +
                " Items WHERE (IDItem = @IDItem)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Items] SET [IDItem] = @IDItem, [ItemName] = @ItemName, [ItemDescription] = @ItemDescription WHERE (([IDItem] = @Original_IDItem) AND ([ItemName] = @Original_ItemName) AND ([ItemDescription] = @Original_ItemDescription));
SELECT IDItem, ItemName, ItemDescription FROM Items WHERE (IDItem = @IDItem)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT IDItem, ItemName, ItemDescription FROM dbo.Items";
        ...
        public virtual int Fill(Database1DataSet3.ItemsDataTable dataTable) {
        ...
        public virtual Database1DataSet3.ItemsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet3.ItemsDataTable dataTable = new Database1DataSet3.ItemsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet3.ItemsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_IDItem, string Original_ItemName, string Original_ItemDescription) {
        ...
        public virtual int Insert(int IDItem, string ItemName, string ItemDescription) {
        ...
        public virtual int Update(int IDItem, string ItemName, string ItemDescription, int Original_IDItem, string Original_ItemName, string Original_ItemDescription) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ItemName, string ItemDescription, int Original_IDItem, string Original_ItemName, string Original_ItemDescription) {
            return this.Update(Original_IDItem, ItemName, ItemDescription, Original_IDItem, Original_ItemName, Original_ItemDescription);
        }
    }
